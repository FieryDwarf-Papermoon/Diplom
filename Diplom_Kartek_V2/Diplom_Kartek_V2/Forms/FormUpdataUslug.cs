...
{
    public partial class FormUpdataUslug : Form
    {
        public FormUpdataUslug()
        {
            InitializeComponent();
        }
        ...
        private void FormUpdataUslug_Load(object sender, EventArgs e)
        {
            ...
            LoadTheme();
            bindingSource = uslugBindingSource;
